...
?>
<section class="tc-single-article-hero relative h-[55vh] md:h-[65vh] w-full overflow-hidden flex items-end"
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 pb-12 md:pb-16 w-full">
        ...
        <?php if ($subtitle): ?>
            <p class="text-base md:text-lg text-white/85 mt-4 max-w-3xl font-light italic"><?php echo esc_html($subtitle); ?></p>
        <?php endif; ?>
    </div>
</section>