...
$eyebrow = get_field('about_philosophy_eyebrow');
$heading = get_field('about_philosophy_heading');
$body = get_field('about_philosophy_body');

if (!$heading && !$body) return;
?>
<section id="tc-about-philosophy" class="tc-about-philosophy bg-white py-24 md:py-32">
