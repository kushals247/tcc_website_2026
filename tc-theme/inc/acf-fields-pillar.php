...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_subcat_intro_eyebrow',
                'label' => 'Intro eyebrow',
                'name' => 'subcat_intro_eyebrow',
                'type' => 'text',
                'default_value' => 'EXPLORE THE CATEGORY',
            ],
            [
                'key' => 'field_subcat_intro_heading',
                'label' => 'Intro heading',
                'name' => 'subcat_intro_heading',
                'type' => 'text',
            ],
            [
                'key' => 'field_subcat_intro_body',
                'label' => 'Intro body',
                'name' => 'subcat_intro_body',
                'type' => 'textarea',
                'instructions' => 'Short positioning paragraph (~80 words) explaining what this category covers and who it is for.',
            ],
            [
                'key' => 'field_subcat_products_shortcode',
                'label' => 'WooCommerce product list shortcode',
                'name' => 'subcat_products_shortcode',
                'type' => 'textarea',
                'placeholder' => '[products category="roofing" limit="12"]',
                'instructions' => 'Paste a WooCommerce [products] or [product_category] shortcode here. Until you add a shortcode, a polished "catalogue coming soon" placeholder shows instead.',
            ],
            [
                'key' => 'field_subcat_considerations_eyebrow',
                'label' => 'Considerations eyebrow',
                'name' => 'subcat_considerations_eyebrow',
                'type' => 'text',
                'default_value' => 'THINGS TO CONSIDER',
            ],
            [
                'key' => 'field_subcat_considerations_heading',
                'label' => 'Considerations heading',
                'name' => 'subcat_considerations_heading',
                'type' => 'text',
            ],
            [
                'key' => 'field_subcat_considerations_items',
                'label' => 'Consideration items',
                'name' => 'subcat_considerations_items',
                'type' => 'repeater',
                'layout' => 'block',
                'min' => 0,
                'max' => 4,
                'sub_fields' => [
                    ['key' => 'field_consideration_headline', 'label' => 'Headline', 'name' => 'headline', 'type' => 'text'],
                    ['key' => 'field_consideration_body', 'label' => 'Body', 'name' => 'body', 'type' => 'textarea'],
                ],
            ],
            [
                'key' => 'field_subcat_brands_eyebrow',
                'label' => 'Brands eyebrow',
                'name' => 'subcat_brands_eyebrow',
                'type' => 'text',
                'default_value' => 'OUR PARTNERS',
            ],
            [
                'key' => 'field_subcat_brands_heading',
                'label' => 'Brands heading',
                'name' => 'subcat_brands_heading',
                'type' => 'text',
                'default_value' => 'Brands we carry for this category',
            ],
            [
                'key' => 'field_subcat_articles_eyebrow',
                'label' => 'Articles eyebrow',
                'name' => 'subcat_articles_eyebrow',
                'type' => 'text',
                'default_value' => 'READ MORE',
            ],
            [
                'key' => 'field_subcat_articles_heading',
                'label' => 'Articles heading',
                'name' => 'subcat_articles_heading',
                'type' => 'text',
                'default_value' => 'Related guides and stories',
            ],
            [
                'key' => 'field_subcat_cta_eyebrow',
                'label' => 'CTA eyebrow',
                'name' => 'subcat_cta_eyebrow',
                'type' => 'text',
                'default_value' => 'NEED HELP CHOOSING?',
            ],
            [
                'key' => 'field_subcat_cta_heading',
                'label' => 'CTA heading',
                'name' => 'subcat_cta_heading',
                'type' => 'text',
                'default_value' => 'Speak to our specification team.',
            ],
            [
                'key' => 'field_subcat_cta_body',
                'label' => 'CTA body',
                'name' => 'subcat_cta_body',
                'type' => 'textarea',
            ],
        ],
    ]);
